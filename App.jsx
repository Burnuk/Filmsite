...
// JSONBin.io kullanarak ücretsiz ve kalıcı yorum saklama
// Kullanıcı kendi BIN ID'sini .env'e ekler
    ...
    <div style={S.page}>
      ...
      {DEMO_MODE && (
        <div style={{ background: "#1a1200", borderBottom: "1px solid #3a2800", padding: "10px 24px", fontSize: 13, color: "#F5A623", textAlign: "center" }}>
          ⚠️ Demo mod — yorumlar sadece bu tarayıcıda saklanıyor. Gerçek sunucu için <strong>.env</strong> dosyasını yapılandırın.
        </div>
      )}
