...
const FILMS = [
  ...
  { id: 7,   title: "The Godfather Part II",           year: 1974, director: "Francis Ford Coppola",  genre: "Suc / Dram",         rating: 9.0, imdb: "tt0071562", desc: "Corleone ailesinin yukselisi." },
  ...
  { id: 18,  title: "The Matrix",                      year: 1999, director: "Lana Wachowski",        genre: "Bilim Kurgu",        rating: 8.7, imdb: "tt0133093", desc: "Gercekligin aslinda simulasyon oldugunu ogrenen hacker." },
  ...
  { id: 60,  title: "Lawrence of Arabia",              year: 1962, director: "David Lean",            genre: "Tarih / Macera",     rating: 8.3, imdb: "tt0056172", desc: "T.E. Lawrence'in Arap Isyanindaki hikayesi." },
...
function FilmCard({ f, comments, onClick }) {
  ...
  return (
    <div className="card" onClick={onClick}>
      <div className="cimg">
        {poster ? <img src={poster} alt={f.title}/> : <div className="placeholder">{f.title}</div>}
