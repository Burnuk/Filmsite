...
const FILMS = [
  ...
  { id: 5, title: "The Godfather", year: 1972, director: "Francis Ford Coppola", genre: "Suc / Dram", rating: 9.2, cover: "https://image.tmdb.org/t/p/w500/3bhkrj58Vtu7enYsLegHejKInNI.jpg", desc: "Amerika'nin en guclu mafya ailesi Corleone'nin iktidar mucadelesi." },
];
      ...
      {!film ? (
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px" }}>
          <div style={{ marginBottom: 40, textAlign: "center" }}>
            <h1 style={{ fontSize: 36, fontWeight: "normal", letterSpacing: 4, color: "#fff", margin: "0 0 8px" }}>FILM ARSIVI</h1>
            <p style={{ color: "#666", fontSize: 14, margin: 0 }}>Bir film secin, yorumunuzu birakin</p>
          </div>
          ...
          <div style={{ textAlign: "center", padding: "48px 0 24px", color: "#444", fontSize: 13 }}>
            Made by Bilgehan Yakici
          </div>
        </div>
      ) : (
